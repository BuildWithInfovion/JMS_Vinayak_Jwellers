...
const InvoicePreview = ({
  ...
  // Standard Gold GST is 3% on (Metal Value + Making Charges)
  const gstRate = 0.03;
    ...
    >
      <div id="invoice-content-printable">
        ...
        <div className="text-center mb-8 pb-6 border-b-2 border-gray-200">
          ...
          {/* Show GSTIN only if enabled */}
          {siteConfig.enableGstBilling && siteConfig.gstNumber && (
